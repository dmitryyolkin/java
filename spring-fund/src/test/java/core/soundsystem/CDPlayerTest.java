...
import core.soundsystem.config.separate.SoundSystemConfig;
...
//@ContextConfiguration(classes = CDPlayerWithBeanConfig.class) // -- core.soundsystem.config with help of @Bean instead of @ComponentScan
