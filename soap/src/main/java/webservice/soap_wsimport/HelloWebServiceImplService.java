 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceImplService", targetNamespace = "http://soap_wsimport.webservice/", wsdlLocation = "http://localhost:1986/wss/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICEIMPLSERVICE_QNAME = new QName("http://soap_wsimport.webservice/", "HelloWebServiceImplService");
    ...
    public HelloWebService getHelloWebServiceImplPort() {
        return super.getPort(new QName("http://soap_wsimport.webservice/", "HelloWebServiceImplPort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap_wsimport.webservice/", "HelloWebServiceImplPort"), HelloWebService.class, features);
    }
